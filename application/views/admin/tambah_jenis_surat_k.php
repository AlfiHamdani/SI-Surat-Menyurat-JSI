        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>c_admin/jenis_surat_keluar">Jenis Surat</a></li>
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('c_admin/insert_jenis_sk'); ?>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jenis Surat</label>
                      <input type="text" class="form-control" name="jenis" placeholder="Jenis Surat" required/>
                  </div>
                  <a href="<?php echo base_url(); ?>c_admin/jenis_surat" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
