        ...
        <!-- Content Header (Page header) -->
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('c_surat_masuk/update_surat_masuk'); ?>
                <?php  
                ...
                ?>
                  ...
                  <a href="<?php echo base_url(); ?>c_surat_masuk/arsip_surat_Masuk" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
