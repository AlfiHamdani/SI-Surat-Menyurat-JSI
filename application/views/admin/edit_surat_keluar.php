        ...
        <!-- Content Header (Page header) -->
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('c_admin/update_surat_keluar'); ?>
                <?php  
                ...
                ?>
                  ...
                  <a href="<?php echo base_url(); ?>c_admin/arsip_surat_keluar" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
